 ...
 * @export
 * @interface ApiMailoutModelV2
 */
export interface ApiMailoutModelV2 {
    /**
    ...
    /**
     * Indicates whether to send an SMS aswell as the email, SmsReceiverPhoneNumber must be set, and content cannot be more than 1000 characters, and must not include links
     * @type {boolean}
     * @memberof ApiMailoutModelV2
     */
    'sendAsSms': boolean;
    /**
     * Phone number of the receiver, only phone numbers from Denmark, The Faroe Islands, and Greenland are allowed
     * @type {string}
     * @memberof ApiMailoutModelV2
     */

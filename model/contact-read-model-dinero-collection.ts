...
// @ts-ignore
import type { ContactReadModel } from './contact-read-model';
// May contain unused imports in some cases
// @ts-ignore
 ...
 * 
 * @export
 * @interface ContactReadModelDineroCollection
 */
export interface ContactReadModelDineroCollection {
    /**
     * Collection containing the result of the request.
     * @type {Array<ContactReadModel>}
     * @memberof ContactReadModelDineroCollection
     */
    'collection'?: Array<ContactReadModel> | null;
    /**
     * 

...
// @ts-ignore
import type { ContactStateOfAccountEntry } from './contact-state-of-account-entry';

/**
 * State of account for a contact
 * @export
 * @interface ContactStateOfAccount
 */
export interface ContactStateOfAccount {
    /**
     * Unique identifier for the contact
     * @type {string}
     * @memberof ContactStateOfAccount
     */
    'contactGuid': string;
    /**
     * Summed income
    ...
    'expenses': number;
    /**
     * List of entries related to the contact in the period
     * @type {Array<ContactStateOfAccountEntry>}
     * @memberof ContactStateOfAccount
     */
    'entries'?: Array<ContactStateOfAccountEntry> | null;
}

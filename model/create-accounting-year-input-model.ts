 ...
 * 
 * @export
 * @interface CreateAccountingYearInputModel
 */
export interface CreateAccountingYearInputModel {
    /**
     * Represents the start date of an accounting year.
     * @type {string}
     * @memberof CreateAccountingYearInputModel
     */
    'start': string;
    /**
     * Represents the end date of the accounting year.
     * @type {string}
     * @memberof CreateAccountingYearInputModel
     */
    'end': string;

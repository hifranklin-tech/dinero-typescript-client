...
// @ts-ignore
import type { CreateMonthlyBusinessGoalRequest } from './create-monthly-business-goal-request';

/**
 * 
 * @export
 * @interface CreateYearlyBusinessGoalRequest
 */
export interface CreateYearlyBusinessGoalRequest {
    /**
     * 
     * @type {Array<CreateMonthlyBusinessGoalRequest>}
     * @memberof CreateYearlyBusinessGoalRequest
     */
    'monthlyGoals'?: Array<CreateMonthlyBusinessGoalRequest> | null;
}

...
// @ts-ignore
import type { ElectronicInvoiceSendStatus } from './electronic-invoice-send-status';

/**
 * 
 * @export
 * @interface ElectronicInvoiceSendStatusResult
 */
export interface ElectronicInvoiceSendStatusResult {
    /**
     * 
     * @type {ElectronicInvoiceSendStatus}
     * @memberof ElectronicInvoiceSendStatusResult
     */
    'electronicInvoiceSendStatus': ElectronicInvoiceSendStatus;
}

...
export const ElectronicInvoiceSendStatus = {
    DineroCanSend: 'DineroCanSend',
    ChildCanSend: 'ChildCanSend',
    CannotSend: 'CannotSend',
    ValidateWithPeppol: 'ValidateWithPeppol'
} as const;

export type ElectronicInvoiceSendStatus = typeof ElectronicInvoiceSendStatus[keyof typeof ElectronicInvoiceSendStatus];

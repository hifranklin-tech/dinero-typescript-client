...
// @ts-ignore
import type { EmailRecipientModel } from './email-recipient-model';

/**
 * Information about the send email.
 * @export
 * @interface EmailSentModel
 */
export interface EmailSentModel {
    /**
     * List of recipients.
     * @type {Array<EmailRecipientModel>}
     * @memberof EmailSentModel
     */
    'recipients'?: Array<EmailRecipientModel> | null;
}

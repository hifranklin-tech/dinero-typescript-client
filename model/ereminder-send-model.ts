...
/**
 * Model containing parameters needed to send electronic reminders
 * @export
 * @interface EReminderSendModel
 */
export interface EReminderSendModel {
    /**
     * 
     * @type {PaymentMean}
     * @memberof EReminderSendModel
     */

...
/**
 * Read model for a file posted to the server.
 * @export
 * @interface FileSavedReadModel
 */
export interface FileSavedReadModel {
    /**
     * The guid of the posted file
     * @type {string}
     * @memberof FileSavedReadModel
     */

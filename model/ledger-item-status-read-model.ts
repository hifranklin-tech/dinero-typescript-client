...
/**
 * Model for the ledger item status
 * @export
 * @interface LedgerItemStatusReadModel
 */
export interface LedgerItemStatusReadModel {
    /**
     * The unique identifier to identify a ledger item.
     * @type {string}
     * @memberof LedgerItemStatusReadModel
     */
    'id': string;
    /**
    ...
    'version'?: string | null;
    /**
     * Status for the ledger item. Possible values are Draft, PendingBooking and Booked.
     * @type {string}
     * @memberof LedgerItemStatusReadModel
     */
    'status'?: string | null;
    /**
     * The assigned voucher number. If `null`, no voucher number is assgined yet.
     * @type {number}
     * @memberof LedgerItemStatusReadModel
     */

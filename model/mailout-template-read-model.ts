...
/**
 * Model for the template of the email for an invoice / creditnote / tradeoffer
 * @export
 * @interface MailoutTemplateReadModel
 */
export interface MailoutTemplateReadModel {
    /**
     * Sender email. Defaults to organization email if left empty.
     * @type {string}
     * @memberof MailoutTemplateReadModel
     */
    'sender'?: string | null;
    /**

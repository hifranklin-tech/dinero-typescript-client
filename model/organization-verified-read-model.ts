...
/**
 * Organization information for verification status
 * @export
 * @interface OrganizationVerifiedReadModel
 */
export interface OrganizationVerifiedReadModel {
    /**
     * Specifies if organization is currently verified
     * @type {boolean}
     * @memberof OrganizationVerifiedReadModel
     */
    'isVerified': boolean;
    /**
     * 

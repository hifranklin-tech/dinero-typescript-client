 ...
 * 
 * @export
 * @interface ProductReadModelDineroCollection
 */
export interface ProductReadModelDineroCollection {
    /**
     * Collection containing the result of the request.
     * @type {Array<ProductReadModel>}
     * @memberof ProductReadModelDineroCollection
     */
    'collection'?: Array<ProductReadModel> | null;
    /**
     * 

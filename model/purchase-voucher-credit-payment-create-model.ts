 ...
 * 
 * @export
 * @interface PurchaseVoucherCreditPaymentCreateModel
 */
export interface PurchaseVoucherCreditPaymentCreateModel {
    /**
     ...
     * @type {string}
     * @memberof PurchaseVoucherCreditPaymentCreateModel
     */

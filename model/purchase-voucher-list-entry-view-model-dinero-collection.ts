...
// May contain unused imports in some cases
// @ts-ignore
import type { PurchaseVoucherListEntryViewModel } from './purchase-voucher-list-entry-view-model';

/**
 * 
 * @export
 * @interface PurchaseVoucherListEntryViewModelDineroCollection
 */
export interface PurchaseVoucherListEntryViewModelDineroCollection {
    /**
     * Collection containing the result of the request.
     * @type {Array<PurchaseVoucherListEntryViewModel>}
     * @memberof PurchaseVoucherListEntryViewModelDineroCollection
     */
    'collection'?: Array<PurchaseVoucherListEntryViewModel> | null;
    /**
     * 

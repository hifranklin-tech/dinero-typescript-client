...
/**
 * Represents the result of adding given payment.
 * @export
 * @interface PurchaseVoucherPaymentCalculationsReadModel
 */
export interface PurchaseVoucherPaymentCalculationsReadModel {
    /**
     * The paid amount of the invoice
     * @type {number}
     * @memberof PurchaseVoucherPaymentCalculationsReadModel
     */
    'paidAmount': number;
    /**
     * The remainder amount which is not paid amount - payment amount
     * @type {number}
     * @memberof PurchaseVoucherPaymentCalculationsReadModel
     */
    ...
    /**
     * The amount of the payment in foreign currency
     * @type {number}
     * @memberof PurchaseVoucherPaymentCalculationsReadModel
     */
    'paymentAmountInForeignCurrency'?: number | null;
    /**
     * The exchange rate in case of foreign currency
     * @type {number}
     * @memberof PurchaseVoucherPaymentCalculationsReadModel
     */
    'exchangeRate'?: number | null;
    /**
     * The currency difference in case of foreign currency
     * @type {number}
     * @memberof PurchaseVoucherPaymentCalculationsReadModel
     */
    'currencyDifference'?: number | null;
    /**
     * The amount that is not paid yet
     * @type {number}
     * @memberof PurchaseVoucherPaymentCalculationsReadModel
     */

...
export const SalarySumTaxStateEnum = {
    None: 'None',
    OnlySalarySum: 'OnlySalarySum',
    MixedActivities: 'MixedActivities'
} as const;

export type SalarySumTaxStateEnum = typeof SalarySumTaxStateEnum[keyof typeof SalarySumTaxStateEnum];

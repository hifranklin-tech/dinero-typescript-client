...
/**
 * Model for fetching a credit note.
 * @export
 * @interface SalesCreditNoteCreateFetchModel
 */
export interface SalesCreditNoteCreateFetchModel {
    /**
     ...
     * @type {string}
     * @memberof SalesCreditNoteCreateFetchModel
     */

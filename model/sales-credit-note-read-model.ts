 ...
 * Represent a invoice
 * @export
 * @interface SalesCreditNoteReadModel
 */
export interface SalesCreditNoteReadModel {
    /**
     ...
     * @type {string}
     * @memberof SalesCreditNoteReadModel
     */
    ...
    /**
     * The mailout category can have following values:  einvoice, electronicInvoiceReminder, inkasso, mailout, orderConfirmation, preReminder, reminder, tradeOffer
     * @type {string}
     * @memberof SalesCreditNoteReadModel
     */
    'latestMailOutType'?: string | null;
    /**
     * The payment status can have the following values:  Draft, Booked, Paid, OverPaid or Overdue
     * @type {string}
     * @memberof SalesCreditNoteReadModel
     */

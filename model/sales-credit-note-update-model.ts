...
/**
 * Model for updating a credit note.
 * @export
 * @interface SalesCreditNoteUpdateModel
 */
export interface SalesCreditNoteUpdateModel {
    /**
     ...
     * @type {string}
     * @memberof SalesCreditNoteUpdateModel
     */

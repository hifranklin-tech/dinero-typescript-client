...
/**
 * Subscription summary for an organization
 * @export
 * @interface SubscriptionReadModel
 */
export interface SubscriptionReadModel {
    /**
     * Whether the organization has access to Pro features
     * @type {boolean}
     * @memberof SubscriptionReadModel
     */
    'hasPro': boolean;
    /**
     * Whether the organization has a paying Pro subscription
     * @type {boolean}
     * @memberof SubscriptionReadModel
     */
    'hasPayingPro': boolean;
    /**
     * Whether the organization has a paying Starter subscription
     * @type {boolean}
     * @memberof SubscriptionReadModel
     */
    'hasStarterPlus': boolean;
    /**
     * Whether the organization has a yearly financial statement subscription
     * @type {boolean}
     * @memberof SubscriptionReadModel
     */
    'hasYfs': boolean;

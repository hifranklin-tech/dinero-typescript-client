 ...
 * 
 * @export
 * @interface SupportersAllowedToAccessOrganization
 */
export interface SupportersAllowedToAccessOrganization {
    /**
     * 
     * @type {boolean}
     * @memberof SupportersAllowedToAccessOrganization
     */
    'isSupportersAllowedToAccessOrganization': boolean;
}

...
// May contain unused imports in some cases
// @ts-ignore
import type { TradeOfferReadModel } from './trade-offer-read-model';

/**
 * 
 * @export
 * @interface TradeOfferReadModelDineroCollection
 */
export interface TradeOfferReadModelDineroCollection {
    /**
     * Collection containing the result of the request.
     * @type {Array<TradeOfferReadModel>}
     * @memberof TradeOfferReadModelDineroCollection
     */
    'collection'?: Array<TradeOfferReadModel> | null;
    /**
     * 

 ...
 * 
 * @export
 * @interface TrustPilotValidationResponse
 */
export interface TrustPilotValidationResponse {
    /**
     * 
     * @type {boolean}
     * @memberof TrustPilotValidationResponse
     */
    'shouldAddTrustPilotEmail': boolean;
}

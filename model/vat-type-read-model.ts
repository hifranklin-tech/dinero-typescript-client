...
/**
 * Represents a VAT type
 * @export
 * @interface VatTypeReadModel
 */
export interface VatTypeReadModel {
    /**
     * The short hand VAT code.
     * @type {string}
     * @memberof VatTypeReadModel
     */
    'vatCode'?: string | null;
    /**
     * The descriptive name for the VAT code.
     * @type {string}
     * @memberof VatTypeReadModel
     */
    'name'?: string | null;
